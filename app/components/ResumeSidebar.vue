        ...
        <SidebarContent>
            <SidebarGroup class="px-0">
                <SidebarGroupContent>
                    ...
                    <div v-if="filteredResumes.length === 0" class="p-4 text-center text-sm text-muted-foreground">
                        Nenhum currículo encontrado.
                    </div>

                    <button v-for="resume in filteredResumes" :key="resume.id" @click="selectResume(resume)"
                        ...
                        :class="activeResume?.id === resume.id
            ...
            <form @submit.prevent="createResume">
                <div class="grid gap-4 py-4">
                    <div class="grid gap-2">
                        ...
                        <Input id="name" v-model="createForm.resume_name" required
                            placeholder="Ex: Backend Pleno, Frontend Senior" />
                    </div>
                    <div class="grid gap-2">
                        <Label htmlFor="content">Conteúdo (Markdown)</Label>
                        <Textarea id="content" v-model="createForm.resume_text" required rows="15"
